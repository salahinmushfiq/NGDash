...
import { CustomStacked,GoPencil,Button, SparkLine, CustomLine} from '../components';
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
            <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md-w-780'>
              ...
              <div className='mt-10 flex gap-10 flex-wrap justify-center'>
                <div className='lg:border-r-1 lg:border-b-0 border-color m-4 pr-10 xs:border-r-0 xs:border-b-1 sm:border-r-0 sm:border-b-1'>
                    <div>
                      <p>
               ...
               <div className='justify-center items-center'>
                 ...
                 <CustomStacked width="320px" height="360px" ratio="1"/> 
               </div>
